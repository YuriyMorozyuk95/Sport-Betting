...
namespace SportBetting.WPF.Prism.Modules.StationVerification.ViewModels
{
    ...
    public class StationVerificationViewModel : BaseViewModel
    {
        ...
        DeviceInventory di_cash = new DeviceInventory();
        DeviceInventory di_coin = new DeviceInventory();
